...
abstract public class Entity {
    ...
    static List<Integer> insert(List<Entity> objects) throws IOException {
        if (objects.isEmpty()) {
    ...
    static List<Integer> update(List<Entity> objects) throws IOException {
        if (objects.isEmpty()) {
            return new LinkedList<>();
        }
    ...
    static List<Integer> delete(List<Entity> objects) throws IOException {
        if (objects.isEmpty()) {
            return new LinkedList<>();
        }
